package com.example.helloworld.demo.cache;
...
public class TagCache {
    ...
    public static String tagCheck(String str) {
        ...
        String inValid = Arrays.stream(tags).filter(tag -> !tagList.contains(tag)).collect(Collectors.joining(","));
        return inValid;
    }
}
